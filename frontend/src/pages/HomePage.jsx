...
const HomePage = () => {
 ...
 <div className="text-center">
   <div className="inline-block w-full sm:w-auto bg-white text-[#0A2540] px-7 py-3.5 rounded-xl text-[2rem] sm:text-[2rem] font-black tracking-tight leading-tight mb-6 inline-badge hero-title-badge font-ghayaty transform-none shadow-[0_6px_18px_rgba(0,0,0,0.06)] ring-1 ring-black/5"
        style={{
          width: '100%',
          height: 'auto',
          display: 'flex',
 ...
 {/* مساحة بيضاء فارغة للجوال فقط - تم تقليلها بسبب العنوان الأكبر */}
      {/* glowing orb */}
      <span className="glow-orb" style={{ top: '50%', left: '50%' }} aria-hidden></span>
